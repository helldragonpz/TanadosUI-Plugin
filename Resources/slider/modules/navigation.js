...
import { playNow, fetchItemDetails, getCachedUserTopGenres, getGenresForDot, goToDetailsPage } from "../../Plugins/TanadosUI/runtime/api.js";
...
function ensureFlickerFixCSS() {
  ...
  st.textContent = `
    #TanadosUI-slides-container.peak-mode .TanadosUI-slide {
      will-change: transform, opacity;
      backface-visibility: hidden;
    }
    .TanadosUI-slide.is-hidden {
      visibility: hidden !important;
      pointer-events: none !important;
    }
    #TanadosUI-slides-container.peak-first-reveal {
      opacity: 0 !important;
    }
    #TanadosUI-slides-container.peak-first-reveal.peak-first-reveal-active {
      opacity: 1 !important;
      transition: opacity .22s cubic-bezier(.2,.6,.2,1) !important;
    }
    .TanadosUI-slide.is-visible {
      visibility: visible !important;
      pointer-events: auto !important;
    }
    .TanadosUI-slide.peak-batch-pending,
    .TanadosUI-slide.peak-batch-pending * {
    ...
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide {
      transition:
    ...
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide.active {
      box-shadow: none !important;
    }
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-backdrop {
      transition: opacity var(--peak-shift-opacity-ms, 220ms) ease-out !important;
      will-change: opacity !important;
    }
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-button-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-button-container *,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-director-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-horizontal-gradient-overlay,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-horizontal-gradient-overlay:before,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-horizontal-gradient-overlay:after,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-info-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-language-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-logo-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-logo-container .logo-img,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-main-button-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-meta-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-meta-container *,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-plot-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-plot-container *,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-provider-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-provider-container *,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-slider-wrapper,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-status-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-status-container *,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-title-container,
    #TanadosUI-slides-container.peak-shifting .TanadosUI-slide .TanadosUI-title-container * {
      animation: none !important;
      transition: none !important;
      will-change: auto !important;
    }
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) {
      box-shadow: none !important;
      outline: none !important;
    }
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-button-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-director-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-info-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-language-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-logo-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-main-button-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-meta-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-plot-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-provider-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-slider-wrapper,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-status-container,
    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-mode .TanadosUI-slide.active:not(.backdrop-ready) .TanadosUI-title-container {
      opacity: 0 !important;
      pointer-events: none !important;
      transform: translateY(4px) !important;
      visibility: hidden !important;
    }
    #TanadosUI-slides-container.peak-ready .TanadosUI-slide.peak-snap-in,
    #TanadosUI-slides-container.peak-ready .TanadosUI-slide.peak-snap-in * {
      transition: none !important;
      animation: none !important;
    }
	    #TanadosUI-slides-container.peak-ready .TanadosUI-slide.off-left,
	    #TanadosUI-slides-container.peak-ready .TanadosUI-slide.off-right {
	      visibility: hidden !important;
	      pointer-events: none !important;
	      content-visibility: hidden !important;
	      contain: strict !important;
	    }
	    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-ready .TanadosUI-slide.off-left {
	      transform: translate3d(calc(-50% - 220vw), -50%, 0) scale(.82) !important;
	    }
	    html[data-css-variant=peakslider] #TanadosUI-slides-container.peak-ready .TanadosUI-slide.off-right {
	      transform: translate3d(calc(-50% + 220vw), -50%, 0) scale(.82) !important;
	    }
	  `;
...
function injectPeakLiteCSS() {
  ...
  st.textContent = `
    ...
    #TanadosUI-slides-container.peak-lite {
      contain: none !important;
      will-change: auto !important;
      overflow: visible !important;
    }
    #TanadosUI-slides-container.peak-lite .TanadosUI-slide,
    #TanadosUI-slides-container.peak-lite .TanadosUI-slide .TanadosUI-backdrop {
      contain: none !important;
    ...
    #TanadosUI-slides-container.peak-lite .TanadosUI-slide.active {
      box-shadow: 0 10px 18px -12px rgba(28,39,64,.9) !important;
    }
    #TanadosUI-slides-container.peak-lite .TanadosUI-backdrop,
    #TanadosUI-slides-container.peak-lite .TanadosUI-horizontal-gradient-overlay,
    #TanadosUI-slides-container.peak-lite .TanadosUI-button-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-info-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-language-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-meta-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-plot-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-provider-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-status-container,
    #TanadosUI-slides-container.peak-lite .TanadosUI-title-container {
    ...
    #TanadosUI-slides-container.peak-lite .TanadosUI-slide.active,
    #TanadosUI-slides-container.peak-lite .TanadosUI-slide.active .TanadosUI-backdrop {
      opacity: 1 !important;
      visibility: visible !important;
    }
    #TanadosUI-slides-container.peak-lite .TanadosUI-slide.active img.TanadosUI-backdrop {
      left: 0 !important;
      right: 0 !important;
      width: 100% !important;
...
function syncPeakLiteMode(container = document.querySelector('#TanadosUI-slides-container')) {
  injectPeakLiteCSS();
...
function getPeakViewportContainer(root = document) {
  return root.querySelector?.("#indexPage:not(.hide) #TanadosUI-slides-container, #homePage:not(.hide) #TanadosUI-slides-container, #TanadosUI-slides-container") || null;
}
...
function isPeakViewportMutationNode(node) {
  ...
  if (node.id === 'TanadosUI-slides-container' || node.id === 'indexPage' || node.id === 'homePage') return true;
  return !!node.querySelector?.('#TanadosUI-slides-container, #indexPage, #homePage');
}
...
function promotePeakBackdrop(activeSlide) {
  const backdrop = activeSlide?.__backdropImg || activeSlide?.querySelector?.('.TanadosUI-backdrop');
  if (!backdrop) return;
...
function syncPeakBackdropForState(slide, prevState, nextState) {
  const backdrop = slide?.__backdropImg || slide?.querySelector?.('.TanadosUI-backdrop');
  if (!backdrop) return;
...
function refreshPeakViewport({ forcePrime = false } = {}) {
  ...
  const slides = container.querySelectorAll('.TanadosUI-slide');
...
function scrollContainerToSlide(index, { smooth = true } = {}) {
  const container = document.querySelector("#TanadosUI-slides-container");
  if (!container) return;
  const slides = container.querySelectorAll(".TanadosUI-slide");
...
function hardResetProgressBarEl() {
  const pb = document.querySelector(".TanadosUI-slide-progress-bar");
  if (!pb) return;
...
function getBackdropFromDot(dot) {
  const img = dot?.querySelector?.('.TanadosUI-dot-poster-image');
  if (img?.src) return img.src;
  const slideEl = document.querySelector(`.TanadosUI-slide[data-item-id="${dot?.dataset?.itemId}"]`);
  if (slideEl) {
...
function enterPeakScrollMode() {
  const sc = document.querySelector("#TanadosUI-slides-container");
  if (!sc) return;
  sc.classList.add("peak-scroll");
  sc.querySelectorAll(".TanadosUI-slide").forEach(slide => {
...
export function changeSlide(direction) {
  const slides = getPeakViewportContainer()?.querySelectorAll(".TanadosUI-slide") || document.querySelectorAll(".TanadosUI-slide");
  if (!slides.length) return;
...
function clearManagedDotStateClasses(dot) {
  ...
  dot.classList.remove(
    ...
    "TanadosUI-dot-prev",
    "TanadosUI-dot-next",
    "TanadosUI-dot-hidden",
    "TanadosUI-dot-hidden-prev",
    "TanadosUI-dot-hidden-next"
  );

  Array.from(dot.classList).forEach((className) => {
    if (/^TanadosUI-dot-(prev|next)-\d+$/.test(className)) {
...
function applyDotStateClasses(dots, currentIndex, config, lowPower = false) {
  ...
  dotArray.forEach((dot, arrayIndex) => {
    ...
    if (isActive) {
      ...
      if (isHidden) {
        dot.classList.add("TanadosUI-dot-hidden", `TanadosUI-dot-hidden-${direction}`);
      } else {
        dot.classList.add(`TanadosUI-dot-${direction}`, `TanadosUI-dot-${direction}-${styledDistance}`);
      }
    }
...
export function updateActiveDot() {
  const currentIndex = getCurrentIndex();
  const dots = document.querySelectorAll(".TanadosUI-dot");
  const config = getConfig();
...
export function createDotNavigation() {
  ...
  if (!config.showDotNavigation) {
    const existingDotContainer = document.querySelector(".TanadosUI-dot-navigation-container");
  ...
  const slides = slidesContainer.querySelectorAll(".TanadosUI-slide");
  if (!slides || slides.length === 0) return;

  let dotContainer = slidesContainer.querySelector(".TanadosUI-dot-navigation-container");
  if (!dotContainer) {
    dotContainer = document.createElement("div");
    dotContainer.className = "TanadosUI-dot-navigation-container";
  ...
  if (config.dotPosterMode) {
    ...
    scrollWrapper.className = "TanadosUI-dot-scroll-wrapper";
    ...
    if (!itemId) {
        console.warn(`Dot oluşturulamadı: TanadosUI-slide ${index} için itemId eksik`);
        return null;
    }

    const dot = document.createElement("div");
    dot.className = "TanadosUI-dot TanadosUI-poster-dot";
    ...
    if (imageUrl) {
        ...
        image.className = "TanadosUI-dot-poster-image";
    ...
    try {
        ...
        if (videoStream) {
            ...
            if (qualityText) {
                ...
                qualityBadge.className = "TanadosUI-dot-quality-badge";
        ...
        if (config.showPlaybackProgress && hasPartialPlaybackState({
            ...
            progressContainer.className = "TanadosUI-dot-progress-container";

            const barWrapper = document.createElement("div");
            barWrapper.className = "TanadosUI-dot-duration-bar-wrapper";

            const bar = document.createElement("div");
            bar.className = "TanadosUI-dot-duration-bar";
            ...
            text.className = "TanadosUI-dot-duration-remaining";
        ...
        playButtonContainer.className = "TanadosUI-dot-play-container";

        const playButton = document.createElement("button");
        playButton.className = "TanadosUI-dot-play-button";
      ...
      try {
        ...
        matchBadge.className = "TanadosUI-dot-match-div";
      ...
      const playButton = dot.querySelector('.TanadosUI-dot-play-button');
      if (playButton) {
      ...
      const matchBadge = dot.querySelector('.TanadosUI-dot-match-div');
      if (matchBadge) {
      ...
      if (error?.name !== 'AbortError') {
        console.error('Poster TanadosUI-dot hover hatası:', error);
      ...
      if (!lowPower) {
        setTimeout(() => {
          const createdDots = Array.from(scrollWrapper.querySelectorAll('.TanadosUI-poster-dot'));
    ...
    leftArrow.className = "TanadosUI-dot-arrow TanadosUI-dot-arrow-left";
    leftArrow.innerHTML = "&#10094;";
    ...
    rightArrow.className = "TanadosUI-dot-arrow TanadosUI-dot-arrow-right";
  ...
  slides.forEach((slide, index) => {
    ...
    if (imageUrl) {
      ...
      imageOverlay.className = "TanadosUI-dot-image-overlay";
  ...
  applyDotStateClasses(dotContainer.querySelectorAll(".TanadosUI-dot"), currentDotIndex, config, lowPower);
}
...
async function openModalForDot(dot, itemId, signal) {
  ...
  if (modalState.videoModal) {
    ...
    resetModalButtons();
    if (modalState._modalContext !== 'TanadosUI-dot') {
      destroyVideoModal();
    } else {
  ...
  if (!modalState.videoModal || !document.body.contains(modalState.videoModal)) {
    const modalElements = createVideoModal({ showButtons: true, context: 'TanadosUI-dot' });
...
export function centerActiveDot({ smooth = true, force = false } = {}) {
  ...
  const scrollWrapper = document.querySelector(".TanadosUI-dot-scroll-wrapper");
  const activeDot = scrollWrapper?.querySelector(".TanadosUI-poster-dot.active");
...
export function displaySlide(index) {
  ...
  if (!document.querySelector(".TanadosUI-dot-navigation-container")) {
    createDotNavigation();
  }
  ...
  const activeSlide = slidesContainer.querySelector(".TanadosUI-slide.active");
    ...
    if (!isPeak) {
      ...
      if (!enableAnims) {
        ...
        const currentBackdrop =
          ...
          currentSlide.querySelector?.('img.TanadosUI-backdrop') ||
          currentSlide.querySelector?.('.TanadosUI-backdrop') ||
          null;
        if (currentBackdrop) {
  ...
  requestAnimationFrame(() => {
    ...
    const directorContainer = currentSlide.querySelector(".TanadosUI-director-container");
...
export function updatePeakClasses(slides, activeIndex, spanOrOpts = 2) {
  ...
  if (window.__peakBooting) {
    ...
    const container = arr[0]?.closest?.('#TanadosUI-slides-container') || getPeakViewportContainer();
    if (container) {
...
function syncPeakStructure(root = null, { forcePrime = false } = {}) {
  ...
  const container = base.querySelector?.('#TanadosUI-slides-container') || getPeakViewportContainer();
...
function initSliderArrows(slide) {
  const actorContainer = slide.querySelector(".TanadosUI-artist-container");
  const leftArrow = slide.querySelector(".TanadosUI-slider-arrow.left");
  const rightArrow = slide.querySelector(".TanadosUI-slider-arrow.right");
  const lowPower = isLowPowerPeakRuntime();
...
function ensureDotQualityBadgeCSS() {
  ...
  style.textContent = `
    ...
    .TanadosUI-dot-quality-badge img.range-icon,
    .TanadosUI-dot-quality-badge img.codec-icon,
    .TanadosUI-dot-quality-badge img.quality-icon {
      width: 20px;
      height: 14px;
...
export function enablePeakNeighborActivation() {
  ...
  container.addEventListener('click', (e) => {
    ...
    if (e.target.closest?.('[data-no-peak-activate="1"], .TanadosUI-dot-navigation-container')) return;

    const x = e.clientX, y = e.clientY;
    const topEl    = document.elementFromPoint(x, y);
    const topSlide = topEl?.closest?.('.TanadosUI-slide');
    if (!topSlide) return;
    ...
    const slides = Array.from(container.querySelectorAll('.TanadosUI-slide'));
  ...
  if (!document.getElementById('peak-neighbor-cursor-css')) {
    ...
    style.textContent = `.peak-ready .TanadosUI-slide.peak-neighbor{ cursor:pointer; }`;
    document.head.appendChild(style);
  }
}
