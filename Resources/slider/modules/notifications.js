import { makeApiRequest, getSessionInfo, fetchItemDetails, getVideoStreamUrl, playNow, isCurrentUserAdmin, fetchItemsBulk } from "../../Plugins/TanadosUI/runtime/api.js";
...
function getDetailFor(n) {
  ...
  li.innerHTML = `
    ...
    <div class="actions">
      <a class="lnk" target="_blank" rel="noopener" href="${escapeHtml(n.url || "https://github.com/helldragonpz/Jellyfin-TanadosUI-Plugin/releases")}">
...
export function renderUpdateBanner() {
  ...
  lnk.href = data.url || "https://github.com/helldragonpz/Jellyfin-TanadosUI-Plugin/releases";
...
(() => {
  ...
  function addUpdate() {
    ...
    try { window.jfNotifyUpdateAvailable({ latest:v, url:"https://github.com/helldragonpz/Jellyfin-TanadosUI-Plugin/releases", remindMs:0 }); } catch {}
    if (S.autoOpenModal) openModalHard();
  }
