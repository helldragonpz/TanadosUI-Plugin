...
function shouldIgnoreNativePlayInterception(element) {
  ...
  return !!element.closest([
    ...
    "#TanadosUI-watchlist-modal-root",
    ".video-preview-modal",
    ".TanadosUI-trailer-modal-overlay",
    ".TanadosUI-castmodal",
    ".jms-cast-modal",
    ".TanadosUI-main-button-container",
    ".TanadosUI-dot-play-container",
    ".preview-play-button",
    ".jms-parental-pin-backdrop"
  ].join(", "));
}
...
function installNativePlayInterceptor() {
  ...
  const runPlayNow = async (itemId) => {
    try {
      const apiModule = await import("../../Plugins/TanadosUI/runtime/api.js");
