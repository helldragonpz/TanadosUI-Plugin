...
function normalizeRuntimePayload(payload = {}, { includeSecrets = false } = {}) {
  ...
  return {
    ...
    showNativeHomeTabs: normalizeBoolean(raw.showNativeHomeTabs, DEFAULT_RUNTIME_CONFIG.showNativeHomeTabs),
    showWatchlistInTopNav: normalizeBoolean(raw.showWatchlistInTopNav, DEFAULT_RUNTIME_CONFIG.showWatchlistInTopNav),
