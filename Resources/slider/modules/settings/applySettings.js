...
async function updateCastModuleSettings_apply(patch = {}) {
  ...
  const res = await fetch("/Plugins/TanadosUI/cast/settings", {
    method: "POST",
    cache: "no-store",
    headers,
      ...
      isAdmin = await isAdminUser_apply();
        ...
        const runtimeConfigPatch = hasRuntimeConfigFields
          ? {
              ...
              ShowNativeHomeTabs: boolFromFd('ShowNativeHomeTabs', true),
              ShowWatchlistInTopNav: boolFromFd('ShowWatchlistInTopNav', true),
