...
export function createPositionEditor(config, labels, section) {
  ...
  if (target === 'homeSections') {
    ...
    const selector = containerType
      ? (containerType === 'button' ? '.TanadosUI-main-button-container'
        : containerType === 'slider' ? '.TanadosUI-slider-wrapper'
        : containerType === 'existingDot' ? '.TanadosUI-dot-navigation-container'
        : containerType === 'progress' ? '.TanadosUI-slide-progress-bar'
        : containerType === 'progressSeconds' ? '.TanadosUI-slide-progress-seconds'
        : `.TanadosUI-${containerType}-container`)
